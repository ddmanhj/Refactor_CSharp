...
namespace Loops
{
    internal class TextAdventureGame
    {
        public void TextAdventureGameProgram()
        {
            ...
            while (gameContinues)
            {
                ...
                else
                {
                    ...
                    Console.WriteLine("Fight or flee? (flight/flee)");
                    string flightChoice = Console.ReadLine();
                    if (flightChoice.ToLower() == "fight")
                    {
                        ...
                        else
                        {
                            ...
                            Console.WriteLine("It rammed it's tucks into your chest and you bleed out!");
                            gameContinues = false;
                        }
                    }
                }
